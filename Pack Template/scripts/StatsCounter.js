...
function initializeObjectives(player){
	...
	//achievements--------------------
		...
		achievementArray[3] = "Assist an axolotl in a fight";
		achievementArray[4] = "Bake a cake";
		achievementArray[5] = "Bounce up 30m from a slime block";
		achievementArray[6] = "Breed a mule";
		achievementArray[7] = "Breed two cows";
		achievementArray[8] = "Breed two pandas";
		achievementArray[9] = "Buy something for 1 emerald";
		achievementArray[10] = "Connect 3 Chests to a Furnace";
		achievementArray[11] = "Create an Iron Golem";
		achievementArray[12] = "Cure a zombie villager";
		achievementArray[13] = "Dig up a buried treasure";
		achievementArray[14] = "Discover 17 biomes";
		achievementArray[15] = "Distract a Piglin using gold";
		achievementArray[16] = "Do nine hearts damage in one hit";
		achievementArray[17] = "Dry a sponge";
		achievementArray[18] = "Dye a full leather armor set";
		achievementArray[19] = "Eat a pork chop";
		achievementArray[20] = "Eat an Enchanted Apple";
		achievementArray[21] = "Eat cooked rabbit";
		achievementArray[22] = "Eat only dried kelp for 3 days";
		achievementArray[23] = "Eat Rotten Flesh";
		achievementArray[24] = "Enter an End Portal";
		achievementArray[25] = "Fall from build limit and live";
		achievementArray[26] = "Feed a dolphin";
		achievementArray[27] = "Find a shipwreck";
		achievementArray[28] = "Find an underwater ruin";
		achievementArray[29] = "Float with a goat in a boat";
		achievementArray[30] = "Get 16 colors of wool";
		achievementArray[31] = "Get a blaze rod";
		achievementArray[32] = "Get a bucket of fish";
		achievementArray[33] = "Get a cooked fish";
		achievementArray[34] = "Get a crafting table";
		achievementArray[35] = "Get a diamond";
		achievementArray[36] = "Get a full Iron armor set";
		achievementArray[37] = "Get a full Netherite armor set";
		achievementArray[38] = "Get a gift from a cat";
		achievementArray[39] = "Get a log";
		achievementArray[40] = "Get a map from a cartographer, then visit the structure";
		achievementArray[41] = "Get all 3 froglights";
		achievementArray[42] = "Get an iron ingot";
		achievementArray[43] = "Get a bottle of dragons breath";
		achievementArray[44] = "Get bread";
		achievementArray[45] = "Get experience from a Grindstone";
		achievementArray[46] = "Get Honey without upsetting the bees";
		achievementArray[47] = "Get or spend 30 Emeralds from trading";
		achievementArray[48] = "Get a potion from a brewing stand";
		achievementArray[49] = "Get some leather";
		achievementArray[50] = "Get wool with shears";
		achievementArray[51] = "Give someone a suspicious stew";
		achievementArray[52] = "Swim in lava with Fire Resistance";
		achievementArray[53] = "Have an Allay drop a cake at a noteblock";
		achievementArray[54] = "Hit a Target block bullseye";
		achievementArray[55] = "Kill a creeper with arrows";
		achievementArray[56] = "Kill a ghast with a fireball";
		achievementArray[57] = "Kill a mob near a catalyst";
		achievementArray[58] = "Kill a monster";
		achievementArray[59] = "Kill a Pillager Captain";
		achievementArray[60] = "Kill a Ravager";
		achievementArray[61] = "Kill a Skeleton with an arrow from 50m";
		achievementArray[62] = "Kill an Elder Guardian";
		achievementArray[63] = "Kill an Evoker";
		achievementArray[64] = "Kill mob while wearing the same head";
		achievementArray[65] = "Kill the Enderdragon";
		achievementArray[66] = "Kill the Wither";
		achievementArray[67] = "Lead a Caravan of 5 Llamas";
		achievementArray[68] = "Make a Decorated Pot";
		achievementArray[69] = "Make a Dispenser";
		achievementArray[70] = "Make a fully powered Beacon";
		achievementArray[71] = "Make a furnace";
		achievementArray[72] = "Make a Hoe";
		achievementArray[73] = "Make a Nether Portal";
		achievementArray[74] = "Make a pickaxe, shovel, axe, and hoe with the same material";
		achievementArray[75] = "Make a stone pickaxe";
		achievementArray[76] = "Make an Enchanted Apple banner";
		achievementArray[77] = "Make an Enchantment Table";
		achievementArray[78] = "Make any type of pickaxe";
		achievementArray[79] = "Make any type of sword";
		achievementArray[80] = "Make some bookshelves";
		achievementArray[81] = "Mine 1728 Cobblestone";
		achievementArray[82] = "Move a Bee Nest with 3 bees";
		achievementArray[83] = "Name a Shulker Box";
		achievementArray[84] = "Open your inventory";
		achievementArray[85] = "Place 9 maps on the wall";
		achievementArray[86] = "Place a Flower Pot";
		achievementArray[87] = "Place an Oak Sign";
		achievementArray[88] = "Place four Sea Pickles";
		achievementArray[89] = "Place scaffolding to the build limit";
		achievementArray[90] = "Plant a Sniffer seed";
		achievementArray[91] = "Play for 100 days";
		achievementArray[92] = "Poison a witch with a splash potion";
		achievementArray[93] = "Power a furnace with kelp";
		achievementArray[94] = "Power a Furnace with Lava";
		achievementArray[95] = "Push a piston with a piston, then pull the original piston with that piston";
		achievementArray[96] = "Respawn the Enderdragon";
		achievementArray[97] = "Ride a pig while it suffers fall damage";
		achievementArray[98] = "Ride a strider 50m in the Overworld";
		achievementArray[99] = "Ring the bell with hostiles in the village";
		achievementArray[100] = "Levitate up 50m from a Shulker attack";
		achievementArray[101] = "Slide down a honey block";
		achievementArray[102] = "Smelt a log with charcoal";
		achievementArray[103] = "Sneak past a Sculk Sensor";
		achievementArray[104] = "Spawn the Wither";
		achievementArray[105] = "Spend a day underwater";
		achievementArray[106] = "Stay underwater for 2min";
		achievementArray[107] = "Tame 20 cats";
		achievementArray[108] = "Tame a horse";
		achievementArray[109] = "Tame an Ocelot";
		achievementArray[110] = "Tame five wolves";
		achievementArray[111] = "Throw diamonds at a player";
		achievementArray[112] = "Trade at y320";
		achievementArray[113] = "Trade for 1000 emeralds";
		achievementArray[114] = "Travel 500m in one minecart trip";
		achievementArray[115] = "Trigger a Pillager Raid";
		achievementArray[116] = "Use a Hopper from a Chest Minecart to a Chest";
		achievementArray[117] = "Use a jukebox in a Meadow";
		achievementArray[118] = "Use a trident with Riptide";
		achievementArray[119] = "Use the Frost Walker boots";
		achievementArray[120] = "Use the Totem of Undying";
		achievementArray[121] = "Visit all Nether biomes";
	...
	//advancements--------------------
		...
		advancementArray[3] = "Plant a seed";
		advancementArray[4] = "Enter a nether fortress";
		advancementArray[5] = "Hit a mob with a thrown trident";
		advancementArray[6] = "Get an Iron Ingot";
		advancementArray[7] = "Kill or be killed by an entity";
		advancementArray[8] = "Discover every biome";
		advancementArray[9] = "Kill five mobs with one crossbow shot";
		advancementArray[10] = "Bring a Beacon to full power";
		advancementArray[11] = "Get Honey without upsetting the bees";
		advancementArray[12] = "Tame an animal";
		advancementArray[13] = "Have an Allay drop a cake at a noteblock";
		advancementArray[14] = "Make a beacon";
		advancementArray[15] = "Get a Tadpole Bucket";
		advancementArray[16] = "Hit a Target bullseye from 30m";
		advancementArray[17] = "Make a Decorated Pot";
		advancementArray[18] = "Fall from build limit and live";
		advancementArray[19] = "Use a Compass on a Lodestone";
		advancementArray[20] = "Get a full Netherite armor set";
		advancementArray[21] = "Get some diamond armor";
		advancementArray[22] = "Get some trimmed armor";
		advancementArray[23] = "Get a diamond";
		advancementArray[24] = "Use an Enchanting Table";
		advancementArray[25] = "Enter a stronghold";
		advancementArray[26] = "Ride a strider 50m in the Overworld";
		advancementArray[27] = "Catch a fish";
		advancementArray[28] = "Kill the ender dragon";
		advancementArray[29] = "Get a stone pickaxe";
		advancementArray[30] = "Use a glow ink sac on a sign";
		advancementArray[31] = "Levitate up 50m from a Shulker attack";
		advancementArray[32] = "Get Hero of the Village";
		advancementArray[33] = "Get Ancient Debris";
		advancementArray[34] = "Summon an iron golem";
		advancementArray[35] = "Get a lava bucket";
		advancementArray[36] = "Explore all Nether biomes";
		advancementArray[37] = "Have every effect applied at the same time";
		advancementArray[38] = "Consume any consumable item";
		advancementArray[39] = "Get a block of Obsidian";
		advancementArray[40] = "Get a blaze rod";
		advancementArray[41] = "Look at a Ghast through a Spyglass";
		advancementArray[42] = "Look at a Parrot through a Spyglass";
		advancementArray[43] = "Look at the Ender Dragon through a Spyglass";
		advancementArray[44] = "Get an iron pickaxe";
		advancementArray[45] = "Kill a mob near a Sculk Catalyst";
		advancementArray[46] = "Walk on powder snow while wearing leather boots";
		advancementArray[47] = "Feed a Snifflet";
		advancementArray[48] = "Pick up an item from a brewing stand potion slot";
		advancementArray[49] = "Get a crafting table";
		advancementArray[50] = "Kill any hostile monster";
		advancementArray[51] = "Kill one of every hostile monster";
		advancementArray[52] = "Enter the Nether dimension";
		advancementArray[53] = "Charge a Respawn Anchor to the maximum";
		advancementArray[54] = "Deflect a projectile with a Shield";
		advancementArray[55] = "Distract Piglins with gold";
		advancementArray[56] = "Shoot a Crossbow";
		advancementArray[57] = "Plant any Sniffer seed";
		advancementArray[58] = "Use a Totem of Undying";
		advancementArray[59] = "Go through an end gateway";
		advancementArray[60] = "Get a Pottery Sherd";
		advancementArray[61] = "Kill a Ghast with a fireball";
		advancementArray[62] = "Get a netherite hoe";
		advancementArray[63] = "Get a pair of elytra";
		advancementArray[64] = "Get a Sniffer Egg";
		advancementArray[65] = "Apply Spire, Snout, Rib, Ward, Silence, Vex, Tide, and Wayfinder smithing templates";
		advancementArray[66] = "Sneak past a Sculk Sensor";
		advancementArray[67] = "Kill a Skeleton with an arrow from 50m";
		advancementArray[68] = "Use a jukebox in a meadow";
		advancementArray[69] = "Get a Wither Skeleton skull";
		advancementArray[70] = "Trade with a Villager at the build limit";
		advancementArray[71] = "Break your fall on a Honey Block";
		advancementArray[72] = "Get Cobblestone, Blackstone, or Cobbled Deepslate";
		advancementArray[73] = "Travel 7km in the Overworld";
		advancementArray[74] = "Get any type of iron armor";
		advancementArray[75] = "Protect a Villager from lightning without starting a fire";
		advancementArray[76] = "Sleep in a Bed";
		advancementArray[77] = "Get a fish bucket";
		advancementArray[78] = "Shoot a mob with an Arrow";
		advancementArray[79] = "Enter an end city";
		advancementArray[80] = "Get an Axolotl Bucket";
		advancementArray[81] = "Enter the End dimension";
		advancementArray[82] = "Respawn the Ender Dragon";
		advancementArray[83] = "Enter the End Portal";
		advancementArray[84] = "Team up with an axolotl and win a fight";
		advancementArray[85] = "Hold the Dragon Egg";
		advancementArray[86] = "Breed two animals";
		advancementArray[87] = "Place a comparator on any side of a chiseled bookshelf";
		advancementArray[88] = "Ride a Strider with a Warped Fungus on a Stick";
		advancementArray[89] = "Enter a Bastion Remnant";
		advancementArray[90] = "Move a Bee Nest, with 3 Bees inside";
		advancementArray[91] = "Kill two Phantoms with a piercing Arrow";
		advancementArray[92] = "Breed all the animals";
		advancementArray[93] = "Kill a ghast while the player is in the Overworld";
		advancementArray[94] = "Strike a Villager with lightning";
		advancementArray[95] = "Kill a raid captain";
		advancementArray[96] = "Loot a Chest in a Bastion Remnant";
		advancementArray[97] = "Scrape Wax off of a Copper block";
		advancementArray[98] = "Use a honeycomb on a copper block";
		advancementArray[99] = "Build, light and enter a Nether Portal";
		advancementArray[100] = "Trade with a Villager";
		advancementArray[101] = "Float in a boat with a goat";
		advancementArray[102] = "Get each Frog variant on a Lead";
		advancementArray[103] = "Get Crying Obsidian";
		advancementArray[104] = "Kill a pillager with a crossbow";
		advancementArray[105] = "Get all Froglights";
		advancementArray[106] = "Summon the Wither";
