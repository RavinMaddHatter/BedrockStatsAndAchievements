...
function worldAndBiome(subject, player){
	...
	switch(subject){
		case "biomeChecks" :
			...
			if(!advancementTracker.checkAchievment("AdventuringTime", player)){
				let tempBiome = 0;
